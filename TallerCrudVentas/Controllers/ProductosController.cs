...
namespace TallerCrudVentas.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var ventasAsociadas = await _context.DetalleVentas.AnyAsync(v => v.ProductoId == id);
            if (ventasAsociadas)
            {
                TempData["Error"] = "No se puede eliminar el producto, tiene detalles de ventas asociadas";
                return RedirectToAction(nameof(Index));
            }
